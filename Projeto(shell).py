        ...
        if(subintervalos >0):
            ...
            if(metodo == 1):
                ...
                if(math.isinf(valorIntegral) or math.isinf(valorIntegral1) or math.isinf(valorIntegral2)): #Se o valor das integrais forem números infinitos
                    ...
                    print("Usando o método dos Retângulos = %.4f" % valorIntegral)
                    print("Usando o método dos Trapézios = %.4f" % valorIntegral1)
                    print("Usando o método de Simpson = %.4f" % valorIntegral2)
